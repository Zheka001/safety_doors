...
import numpy as np
# pcd_path = Path('./data/point_cloud_train/clouds_tof')
# files_names = os.listdir(pcd_path)
# files = [pcd_path.joinpath(f).absolute() for f in files_names]
# print(files[0])
# for f in files:
#     with ZipFile(str(f), 'r') as zip:
#         zip.extractall()
